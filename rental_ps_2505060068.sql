...
--
-- Host: localhost    Database: rental_ps_2505060068
-- ------------------------------------------------------
...
INSERT INTO `pelanggan` VALUES ('1','Naufal',1),('2','Arkan',2),('3','El',3),('4','Rochim',4);
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ps` (
  `id_ps` varchar(1) NOT NULL,
  `nama_ps` varchar(60) NOT NULL,
...
INSERT INTO `ps` VALUES ('1','ps6',10),('2','ps7',20),('3','ps67',67),('4','ps76',40);
...
CREATE TABLE `transaksi` (
  `id_transaksi` varchar(1) NOT NULL,
  `id_pelanggan` varchar(1) NOT NULL,
  `id_ps` varchar(1) DEFAULT NULL,
...
INSERT INTO `transaksi` VALUES ('1','1','1',10,100),('2','2','2',20,400),('3','3','3',30,2010),('4','4','4',40,1600);
...
-- Dump completed on 2026-04-13  5:33:36
